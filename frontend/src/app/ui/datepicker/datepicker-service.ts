...
export class NgbDatepickerService {
    private _VALIDATORS: {
        [K in keyof DatepickerServiceInputs]: (
            v: DatepickerServiceInputs[K],
        ) => Partial<DatepickerViewModel> | void;
    } = {
        ...
        weekdays: (weekdays: boolean | TranslationWidth) => {
            const weekdayWidth =
                weekdays === true || weekdays === false ? TranslationWidth.Short : weekdays;
    ...
    private _updateState(patch: Partial<DatepickerViewModel>): DatepickerViewModel {
        ...
        if (startDate) {
            ...
            const yearChanged =
                !this._state.firstDate || this._state.firstDate.year !== state.firstDate.year;
            const monthChanged =
                !this._state.firstDate || this._state.firstDate.month !== state.firstDate.month;
