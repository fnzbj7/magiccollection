    ...
    template: `
        ...
        <ng-template #defaultContentTemplate>
            <div *ngFor="let month of model.months; let i = index" class="ngb-dp-month">
                <div
                    *ngIf="navigation === 'none' || (displayMonths > 1 && navigation === 'select')"
        ...
        <div class="ngb-dp-content" [class.ngb-dp-months]="!contentTemplate" #content>
            <ng-template
                [ngTemplateOutlet]="contentTemplate?.templateRef || defaultContentTemplate"
            ></ng-template>
        </div>
    ...
    implements AfterViewInit, OnDestroy, OnChanges, OnInit, ControlValueAccessor
{
    ...
    private _publicState: NgbDatepickerState = {} as NgbDatepickerState;
    ...
    focus() {
        this._ngZone.onStable
            ...
            .pipe(take(1))
            .subscribe(() => {
                const elementToFocus = this._elementRef.nativeElement.querySelector<HTMLDivElement>(
    ...
    navigateTo(date?: { year: number; month: number; day?: number }) {
        this._service.open(
            NgbDate.from(date ? (date.day ? (date as NgbDateStruct) : { ...date, day: 1 }) : null),
        );
    }
    ...
    ngAfterViewInit() {
        this._ngZone.runOutsideAngular(() => {
            ...
            merge(focusIns$, focusOuts$)
                ...
                .subscribe(({ type }) =>
                    this._ngZone.run(() => this._service.set({ focusVisible: type === 'focusin' })),
                );
        });
    }
...
@Component({
    ...
    template: `
        <div *ngIf="viewModel.weekdays.length > 0" class="ngb-dp-week ngb-dp-weekdays" role="row">
            ...
            <div
                *ngFor="let weekday of viewModel.weekdays"
