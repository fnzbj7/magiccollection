...
export class NgbInputDatepicker implements OnChanges, OnDestroy, ControlValueAccessor, Validator {
    ...
    private _zoneSubscription: unknown;
    ...
    constructor(
        ...
        private _dateAdapter: NgbDateAdapter<unknown>,
    ...
    manualDateChange(value: string, updateView = false) {
        ...
        if (inputValueChanged || !updateView) {
            this._onChange(
                this._model ? this._dateAdapter.toModel(this._model) : value === '' ? null : value,
            );
        }
    ...
    private _applyPopupStyling(nativeElement: unknown) {
