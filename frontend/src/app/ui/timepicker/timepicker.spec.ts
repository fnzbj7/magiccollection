...
// const getTimepicker = (el: HTMLElement) => el.querySelector('ngb-timepicker');
...
// const getMeridianButton = (nativeEl: HTMLElement) => nativeEl.querySelector('button.btn-outline-primary');

// const createChangeEvent = (value: string) => ({target: {value}});

// const expectToDisplayTime = (el: HTMLElement, time: string) => {
//   const inputs = getInputs(el);
//   const timeParts = time.split(':');
//   const timeInInputs: string[] = [];
...
// const expectSameValues = (timepicker: NgbTimepicker, config: NgbTimepickerConfig) => {
...
// const customizeConfig = (config: NgbTimepickerConfig) => {
