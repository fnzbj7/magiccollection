            ...
            <div class="ngb-tp">
                <div class="ngb-tp-input-container ngb-tp-hour">
                    ...
                    >
                        ...
                        <span class="visually-hidden" i18n="@@ngb.timepicker.increment-hours"
                    ...
                    >
                        ...
                        <span class="visually-hidden" i18n="@@ngb.timepicker.decrement-hours"
                ...
                <div class="ngb-tp-input-container ngb-tp-minute">
                    ...
                    >
                        <span class="chevron ngb-tp-chevron"></span>
                        <span class="visually-hidden" i18n="@@ngb.timepicker.increment-minutes"
                    ...
                    >
                        <span class="chevron ngb-tp-chevron bottom"></span>
                        <span class="visually-hidden" i18n="@@ngb.timepicker.decrement-minutes"
                ...
                <div *ngIf="seconds" class="ngb-tp-input-container ngb-tp-second">
                    ...
                    >
                        <span class="chevron ngb-tp-chevron"></span>
                        <span class="visually-hidden" i18n="@@ngb.timepicker.increment-seconds"
                    ...
                    >
                        <span class="chevron ngb-tp-chevron bottom"></span>
                        <span class="visually-hidden" i18n="@@ngb.timepicker.decrement-seconds"
    ...
    providers: [
        {
            ...
            useExisting: forwardRef(() => NgbTimepickerComponent),
            multi: true,
        },
    ],
})
export class NgbTimepickerComponent implements ControlValueAccessor, OnChanges {
    ...
    constructor(
        ...
        private _ngbTimeAdapter: NgbTimeAdapter<unknown>,
