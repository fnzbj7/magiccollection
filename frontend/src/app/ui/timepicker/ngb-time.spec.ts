...
describe('NgbTime', () => {
    ...
    it('should have a validity flag', () => {
        ...
        expect(new NgbTime(undefined, 0, 30).isValid()).toBeFalsy();
        expect(new NgbTime(11, undefined, 30).isValid()).toBeFalsy();
        expect(new NgbTime(11, 0, undefined).isValid()).toBeFalsy();
        expect(new NgbTime(undefined, 0, undefined).isValid()).toBeFalsy();
        expect(new NgbTime(undefined, undefined, undefined).isValid()).toBeFalsy();
    });
