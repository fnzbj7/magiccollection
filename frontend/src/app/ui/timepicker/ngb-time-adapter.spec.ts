...
//       expect(adapter.fromModel({hour: 20})).toBeNull();
//     });

//     it('should convert valid time', () => {
//       expect(adapter.fromModel({hour: 19, minute: 5, second: 1})).toEqual({hour: 19, minute: 5, second: 1});
//       expect(adapter.fromModel({hour: 19, minute: 5} )).toEqual({hour: 19, minute: 5, second: null});
//       expect(adapter.fromModel({hour: 19, minute: 5, second: null}))
//           .toEqual({hour: 19, minute: 5, second: null});
//     });
//   });
