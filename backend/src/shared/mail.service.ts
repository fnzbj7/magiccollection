...
export class MailService {
  ...
  constructor() {
    ...
    const template = fs.readFileSync('./templates/registration.hbs');
  ...
  async sendRegMail(authCredentialsDto: AuthCredentialsDto) {
    ...
    try {
        ...
        throw new ServiceUnavailableException('Mail service is not available, please try it again later');
    }
